...
function iboxTools($timeout) {
    return {
        restrict: 'A',
        scope: true,
        templateUrl: '/pos_self_order/static/assets/views/common/ibox_tools.html',
...
function iboxToolsFullScreen($timeout) {
    return {
        restrict: 'A',
        scope: true,
        templateUrl: '/pos_self_order/static/assets/views/common/ibox_tools_full_screen.html',
        controller: function ($scope, $element) {
            // Function for collapse ibox
            $scope.showhide = function () {
                var ibox = $element.closest('div.ibox');
