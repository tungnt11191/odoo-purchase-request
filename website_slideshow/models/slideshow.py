...
class SlideLayer(models.Model):
    ...
    layer_from = fields.Selection([('top', 'Top'), ('right', 'Right'), ('bottom', 'Bottom'), ('left', 'Left')], string='From')
    destination_x = fields.Integer(string='X')
    destination_y = fields.Integer(string='Y')
    ...
    font_style = fields.Char(string='Font Style')
