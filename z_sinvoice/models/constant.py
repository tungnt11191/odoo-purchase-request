...
class Constant:
    ...
    SINVOICE_CREATE_URI = SINVOICE_URI + '/' + 'InvoiceAPI/InvoiceWS/createInvoice' + '/'
    SINVOICE_CREATE_DRAFT_URI = SINVOICE_URI + '/' + 'InvoiceAPI/InvoiceWS/createOrUpdateInvoiceDraft' + '/'
